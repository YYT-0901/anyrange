    ...
    <div className="fixed inset-0 bg-[#e0e5ec] overflow-y-auto overflow-x-hidden">
      <div className="min-h-full w-full flex flex-col items-center justify-center p-6 sm:p-12 lg:p-8 py-8 lg:py-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6 mb-6 lg:mb-8 max-w-4xl w-full px-4 sm:px-0">
          <div 
            className="bg-[#e0e5ec] rounded-2xl p-5 lg:p-6 transition-all hover:scale-105 flex flex-col items-center text-center"
            style={{
        ...
        {/* Buttons */}
        <div className="flex flex-col sm:flex-row gap-3 lg:gap-5 mb-5 lg:mb-6 w-full max-w-lg px-4 sm:px-0">
          <button
        ...
        <div className="space-y-1 text-center">
          ...
          <p className="text-xs sm:text-sm text-[#b5c5d8]">
            新拟态设计 · 冷色系配色 · 无AI感
          </p>
        </div>
      </div>
